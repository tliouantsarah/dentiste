...
// Gérer l'ajout d'un patient
if (isset($_POST['ajouter'])) {
    $nom = $_POST['nom'];
    $prenom = $_POST['prenom'];
    $email = $_POST['email'];

    $sql = "INSERT INTO patients (nom, prenom, email) VALUES (?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        $message = "Erreur lors de l'ajout du patient : " . $stmt->error;
    }
}
...
if (isset($_GET['supprimer'])) {
    ...
    if ($stmt->execute()) {
        ...
        $message = "Erreur lors de la suppression du patient : " . $stmt->error;
    }
}
